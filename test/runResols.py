...
eosPath='/eos/user/c/cmartinp/www/'
...
plottingStuff['highlimityaxis']["PhiBRes"] = {'Q1': 15, 'Q2': 15, '3h': 15, '4h': 10, 'Q3': 10, 'Q4': 10, 'All':5, 'Correlated':5, 'Uncorrelated':20, 'Legacy':5}
...
#files_to_use = ["rossinQcut0_fromJavier_withcoincidence", "rossinQcut0_fromJavier_withcoincidence"]
#files_to_use = ["rossin-step2-CMSSW_14_2_0_pre1-Coin1_Q1-noAgeing-14Oct24", "rossin-step2-CMSSW_14_2_0_pre1-Coin1_Q1-noAgeing-14Oct24"]
files_to_use = ["test-extendedformat", "test-extendedformat"]
#files_to_use = ["prueba","prueba"]
...
#files_to_use = ["rossin_noRPC_withAgeing_ext_newSLFitter_full_12_4_2_v9_simple_nocor"]
#files_to_use = ["rossin-step2-CMSSW_14_2_0_pre1-Coin1_Q1-noAgeing-14Oct24"]
files_to_use = ["test-extendedformat"]
#files_to_use = ["prueba"]
#files_to_use = ["rossinQcut0_fromJavier_withcoincidence"]
